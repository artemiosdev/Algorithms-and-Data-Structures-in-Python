...
Списки `list` в Python - упорядоченные изменяемые коллекции ***объектов*** произвольных типов (почти как массив, но типы могут отличаться, они изменяемые и модифицируемые). 
